local config = {
  cmd = {
    ...
    "-javaagent:/home/zane/.local/share/nvim/lsp/jdt-language-server/lombok.jar",
    "-Xbootclasspath/a:/home/zane/.local/share/nvim/lsp/jdt-language-server/lombok.jar",
    "-jar",
    "/home/zane/.local/share/nvim/lsp/jdt-language-server/plugins/org.eclipse.equinox.launcher_1.6.400.v20210924-0641.jar",
    "-configuration",
    "/home/zane/.local/share/nvim/lsp/jdt-language-server/config_linux",
    "-data",
    "/home/zane/.local/share/nvim/lsp/jdt-language-server/workspace/folder"
  },
